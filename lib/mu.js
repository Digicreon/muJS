...
var mu = mu || new function() {
	...
	this._showProgress = function() {
		if (!mu._cfg.progress)
			return;
		var e = document.getElementById("mu-progress");
		if (!e) {
			e = document.createElement("div");
			e.id = "mu-progress";
			e.style.cssText = "position:fixed;top:0;left:0;height:3px;background:#29d;z-index:99999;transition:width .3s ease;width:0";
